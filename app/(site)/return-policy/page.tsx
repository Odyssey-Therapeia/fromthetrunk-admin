      ...
      <div className="prose prose-sm max-w-none space-y-6 text-muted-foreground">
        ...
        <section className="space-y-3">
          ...
          <ul className="list-disc space-y-1 pl-6">
            ...
            <li>
              The saree must be in its original condition: unworn, unwashed, and
              in its original packaging.
            </li>
            <li>
              Returns are not accepted for items that have been altered, worn,
        ...
        <section className="space-y-3">
          ...
          <ul className="list-disc space-y-1 pl-6">
            <li>
              ...
              processed within{" "}
              <strong className="text-foreground">5 to 7 business days</strong>.
            </li>
