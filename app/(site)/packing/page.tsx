...
export const metadata: Metadata = {
  title: "Packing",
  description: "How From the Trunk prepares, protects, and dispatches each saree order.",
};
  ...
  return (
    <div className="mx-auto w-full max-w-3xl space-y-8 px-4 py-8 sm:space-y-10 sm:px-6 sm:py-12 lg:py-16">
      <ScrollReveal className="space-y-4">
        <p className="text-xs uppercase tracking-[0.4em] text-muted-foreground">Customer Care</p>
        <h1 className="font-serif text-3xl text-foreground sm:text-4xl">Packing</h1>
        <p className="text-sm text-muted-foreground">Last updated: April 2026</p>
      </ScrollReveal>

      <div className="prose prose-sm max-w-none space-y-6 text-muted-foreground">
        <section className="space-y-3">
          <h2 className="font-serif text-xl text-foreground">Prepared With Care</h2>
          <p>
            Each From the Trunk saree is checked before dispatch, folded with
            care, and packed to protect the textile through the delivery journey.
            Our goal is for every piece to arrive clean, composed, and ready to
            be stored or worn.
          </p>
        </section>

        <section className="space-y-3">
          <h2 className="font-serif text-xl text-foreground">What Comes in the Box</h2>
          <ul className="list-disc space-y-1 pl-6">
            <li>Acid-free tissue around the saree to reduce direct abrasion.</li>
            ...
            <li>A sturdy outer box selected to keep the package structured in transit.</li>
          </ul>
        </section>

        <section className="space-y-3">
          <h2 className="font-serif text-xl text-foreground">Before Dispatch</h2>
          <p>
        ...
        <section className="space-y-3">
          <h2 className="font-serif text-xl text-foreground">Receiving Your Saree</h2>
          <p>
        ...
        <section className="space-y-3">
          <h2 className="font-serif text-xl text-foreground">Related Support</h2>
          <p>
