    ...
    <div className="mx-auto w-full max-w-3xl space-y-10 px-6 py-16">
      ...
      <div className="prose prose-sm max-w-none space-y-6 text-muted-foreground">
        <section className="space-y-3">
          ...
          <p>
            When you use From the Trunk, we may collect the following
            information:
          </p>
          <ul className="list-disc pl-6 space-y-1">
            <li>
              <strong className="text-foreground">Account information:</strong>{" "}
              Name, email address, phone number when you create an account or
              sign in via Google, Microsoft, or X.
            </li>
            <li>
              <strong className="text-foreground">Shipping information:</strong>{" "}
              Delivery addresses you provide during checkout.
            </li>
            <li>
              <strong className="text-foreground">Payment information:</strong>{" "}
              Payment is processed securely by Razorpay. We do not store your
              card details.
            </li>
            <li>
              <strong className="text-foreground">Usage data:</strong> Pages
              viewed, interactions with the site, and device information to
        ...
        <section className="space-y-3">
          ...
          <ul className="list-disc pl-6 space-y-1">
            ...
            <li>
              To communicate about your orders, account, and new collections.
            </li>
        ...
        <section className="space-y-3">
          ...
          <ul className="list-disc pl-6 space-y-1">
            ...
            <li>
              Email service providers to send transactional and marketing
              communications.
            </li>
          </ul>
        </section>
        ...
        <section className="space-y-3">
          ...
          <p>
            We use essential cookies for authentication, cart functionality, and
            site operation. We do not use third-party tracking cookies without
            your consent.
          </p>
        </section>
